...
- **Full-screen wizard/stepper:** a multi-step guided flow is its own route rendering a full-screen ceremony, not a modal. Reference: `features/level-up/` (`useLevelUpCeremony` state machine) + `features/ceremony/CeremonyStepRail`.
