...
// HomebrewSpellEffectFields.tsx (mirrors CustomSpellDamageFields' own split
// off CustomSpellEffectFields) to keep the parent's branch count down.
// Conditional nesting mirrors validateCustomSpellCoherence (backend/src/lib/
// spellcasting/custom-spell-validation.ts): saveAbility/saveEffect render
// only for attackType "save", so the fields a submission could carry always
