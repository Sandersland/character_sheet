...
export default function AppHeader() {
  ...
  // (#1176, #1171) that hide the global bar entirely. useMatch("/characters/:id")
  // below is exact and does NOT match the nested /level-up path, so it needs its own match.
