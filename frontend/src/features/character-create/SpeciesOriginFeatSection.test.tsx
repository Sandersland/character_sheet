...
// SpeciesCantripSection's own render-or-not contract + catalog-fetch shape,
// reusing the SAME useFeatCatalog/fetchFeats seam the level-up ASI/feat
// picker uses (AdvancementPanel.test.tsx's own mocking pattern).
