...
// full PHB'14 list (129 spells, cross-checked against dnd5eapi.co's
...
// spells, Cleric/Druid) that on EVERY one of those 129 spells, a
...
//   - 92 sit on 3+ class lists (including Witch Bolt, added to shared.ts by
//     this slice; Cloud of Daggers/Crown of Madness/Friends, added to
//     shared.ts by #1719; and Blade Ward/Phantasmal Force/Arcane Gate,
//     added to shared.ts by #1742 — see below) — authored in shared.ts
//     (#1713), which already fans "sorcerer" membership onto every one of
//     them.
//   All 129 were individually verified to already carry "sorcerer" in
//   classes[]; zero edits to wizard.ts or druid.ts were needed for this
//   slice (36 + 1 + 92 = 129, the full PHB'14 Sorcerer list, no double-count,
//   no gap).
//
...
// which bumped this slice's own membership total from 123 to 126. #1742's
// own non-SRD-3+-list audit later found 3 MORE — Blade Ward, Phantasmal
// Force, and Arcane Gate — bumping the total again from 126 to 129; see
// spells-2014-sorcerer-data.test.ts for the updated count guard.
//
// No other non-SRD/hand-transcribed Sorcerer spell was found beyond the 9
...
// Daggers, Crown of Madness, Friends, Blade Ward, Phantasmal Force, and
// Arcane Gate, all in shared.ts).
