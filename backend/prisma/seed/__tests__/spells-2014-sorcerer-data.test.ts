...
describe("SORCERER_SPELLS_2014 — full PHB'14 Sorcerer membership is complete across all authoring slices", () => {
  // The full PHB'14 Sorcerer spell list (129 spells: dnd5eapi.co's
  ...
  // 126. #1742's own non-SRD-3+-list audit found 3 MORE still — Blade Ward,
  // Phantasmal Force, and Arcane Gate — bumping the total again from 126 to
  // 129) partitioned by which slice authors the row. Every name below must
