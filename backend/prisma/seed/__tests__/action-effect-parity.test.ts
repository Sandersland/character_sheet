...
// UnknownActionError -> 400 that actions.ts's own module doc warns about. This test replaces the
// ~23 hand-maintained `ACTION_EFFECT_FN.someKey).toBeUndefined()` pins that used to guard specific
// cases in backend/src/lib/classes/__tests__/actions.test.ts.
//
...
// dice — for whichever key gets the entry. backend/src/lib/classes/__tests__/actions.test.ts's
// "row-only action keys" block pins the handful of keys with no legitimate reason to ever be dual-homed.
