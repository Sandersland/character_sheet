...
export const SPELLS: CatalogSpell[] = [
  ...
  },
  {
    ...
    range: "60 ft",
    duration: "1 round",
    description: "Speak a one-word command to a creature you can see. It must succeed on a Wisdom save or follow the command on its next turn (approach, drop, flee, grovel, halt). At higher levels: +1 target per slot level above 1st.",
    classes: ["cleric", "paladin"],
    components: { verbal: true, somatic: false, material: false },
  },
  {
  ...
  },
  {
    ...
    description: "You mark a creature as your quarry. You deal an extra 1d6 damage to it whenever you hit it with a weapon attack, and you have advantage on Perception and Survival checks to find it. At higher levels: duration increases with slot level.",
    concentration: true,
    classes: ["ranger"],
    components: { verbal: true, somatic: false, material: false },
  },
  ...
  },
  {
    ...
    range: "90 ft",
    duration: "1 minute",
    description: "Roll 5d8; the total is how many hit points of creatures this spell affects. Starting with the lowest-current-HP creature in a 20-ft radius, each falls unconscious until the spell ends, takes damage, or is shaken awake. At higher levels: +2d8 per slot level above 1st.",
    classes: ["bard", "sorcerer", "wizard"],
  ...
  },
  {
    ...
    range: "30 ft",
    duration: "Concentration, up to 1 minute",
    description: "A creature you can see must succeed on a Wisdom save or fall prone, becoming incapacitated and unable to stand for the duration, overcome with laughter. It repeats the save at the end of each of its turns (with advantage if it took damage).",
    concentration: true,
