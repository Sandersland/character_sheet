...
// FIGHTER_BASE_ROWS'/WARLOCK_BASE_ROWS' comments explain. Commit 1 shape:
// untagged (both editions identical) — mirrors sorcerer-features.ts's own
// pre-#1232-content rows exactly.
export const SORCERER_BASE_ROWS: ClassFeatureRow[] = toRows([
  {
    name: "Spellcasting",
    level: 1,
    source: "class",
...
export const DRACONIC_BLOODLINE_ROWS: ClassFeatureRow[] = toRows([
  {
...
export const WILD_MAGIC_ROWS: ClassFeatureRow[] = toRows([
  {
