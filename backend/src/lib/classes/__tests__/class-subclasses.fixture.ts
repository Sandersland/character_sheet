...
// backend/prisma/seed/rogue-features.ts), keyed lowercase to match this
...
// "Rogue"). Kept as a SECOND constant rather than importing the prisma-side
...
export const LITERAL_ROW_CLASSES = new Set(["fighter", "barbarian", "rogue"]);
