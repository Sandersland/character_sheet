...
// "Rogue", "Warlock", "Wizard"). Kept as a SECOND constant rather than
// importing the prisma-side
...
export const LITERAL_ROW_CLASSES = new Set(["fighter", "barbarian", "rogue", "warlock", "wizard"]);
