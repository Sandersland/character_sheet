...
export const CLASS_SUBCLASSES: Record<string, (string | undefined)[]> = {
  ...
  monk: [undefined, "warrior of the open hand", "way of the open hand", "warrior of shadow", "way of shadow", "warrior of the elements", "way of the four elements", "warrior of mercy"],
