...
// backend/prisma/seed/barbarian-features.ts; #1231,
// backend/prisma/seed/rogue-features.ts; #1234,
// backend/prisma/seed/wizard-features.ts), keyed lowercase to match this
...
// "Rogue", "Wizard"). Kept as a SECOND constant rather than importing the
// prisma-side
...
export const LITERAL_ROW_CLASSES = new Set(["fighter", "barbarian", "rogue", "wizard"]);
