...
// backend/prisma/seed/bard-features.ts), keyed lowercase to match this
...
// "Bard", "Cleric", "Ranger", "Rogue", "Sorcerer", "Warlock", "Wizard"). Kept
// as a SECOND constant rather than importing the prisma-side
