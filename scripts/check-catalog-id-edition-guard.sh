...
backend/src/lib/classes/channel-divinity.ts:234:guarded by crossEditionRejection (GrantedAbility, #1345 Chunk 5) — line moved by #1229's Divine Sense/Abjure Foes gates, reminder arms and the Abjure-Foes name latch comment
