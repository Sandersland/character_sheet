...
backend/src/lib/classes/channel-divinity.ts:227:guarded by crossEditionRejection (GrantedAbility, #1345 Chunk 5) — line moved by #1229's Divine Sense/Abjure Foes gates and reminder arms
